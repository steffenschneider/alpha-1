...
def test():
    ...
    wortliste = ["Kartoffelbrei", "Quiche", "Bonbon", "Toast", "Fischstäbchen", "Kakao", "Pommes", "Bratkartoffel",
                 "Waffel", "Pfannkuchen", "Gummibärchen", "Mangoeis", "Limonade", "Nachtisch", "Maracuja",
                 "Erdbeermarmelade", "Streusel", "Keks", "Schokocreme", "Melone", "Ketchup", "Mandel"]  # 16,12
